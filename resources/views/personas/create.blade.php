            ...
            <form action="{{ route('personas.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent" placeholder="Nombre de la persona">
                    </div>

                    <div>
                        <label for="apellido" class="block text-sm font-medium text-gray-700 mb-2">Apellido *</label>
                        <input type="text" name="apellido" id="apellido" value="{{ old('apellido') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent" placeholder="Apellido de la persona">
                    </div>

                    <div>
                        <label for="dui" class="block text-sm font-medium text-gray-700 mb-2">DUI</label>
                        <input type="text" name="dui" id="dui" value="{{ old('dui') }}" maxlength="10" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent" placeholder="12345678-9">
                    ...
                    <div>
                        ...
                        <input type="email" name="correo" id="correo" value="{{ old('correo') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent" placeholder="correo@ejemplo.com">
                    </div>
                ...
                <div class="bg-indigo-50 p-4 rounded-lg">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-indigo-800">Información sobre personas</h3>
                            <div class="mt-2 text-sm text-indigo-700">
                                <p>Asegúrate de asignar un rol y departamento para una correcta organización del personal.</p>
                            </div>
                        </div>
                    </div>
                </div>
