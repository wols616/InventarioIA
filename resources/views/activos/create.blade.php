...
<body>
    ...
    <form action="{{ route('activos.store') }}" method="POST">
        ...
        <div>
            ...
            <input type="number" name="id_tipo" value="{{ old('id_tipo') }}" required>
        </div>
        <div>
            <label>id_estado (int)</label>
            <input type="number" name="id_estado" value="{{ old('id_estado') }}" required>
        </div>
        <div>
            <label>id_ubicacion_actual (int)</label>
            <input type="number" name="id_ubicacion_actual" value="{{ old('id_ubicacion_actual') }}">
        </div>
        <div>
            <label>codigo</label>
