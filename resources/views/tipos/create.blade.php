...
@section('content')
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-2xl font-bold text-gray-900">Crear Tipo</h1>
        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <label class="flex items-center space-x-3">
                                    <input type="checkbox" name="requiere_serie" value="1" {{ old('requiere_serie') ? 'checked' : '' }} class="w-4 h-4 text-brand-600 border-gray-300 rounded focus:ring-brand-500">
                                    <span class="text-sm font-medium text-gray-700">Requiere número de serie</span>
                                </label>
                                <label class="flex items-center space-x-3">
                                    <input type="checkbox" name="requiere_marca" value="1" {{ old('requiere_marca') ? 'checked' : '' }} class="w-4 h-4 text-brand-600 border-gray-300 rounded focus:ring-brand-500">
                                    <span class="text-sm font-medium text-gray-700">Requiere marca</span>
                                </label>
                                <label class="flex items-center space-x-3">
                                    <input type="checkbox" name="requiere_modelo" value="1" {{ old('requiere_modelo') ? 'checked' : '' }} class="w-4 h-4 text-brand-600 border-gray-300 rounded focus:ring-brand-500">
                                    <span class="text-sm font-medium text-gray-700">Requiere modelo</span>
                                </label>
                                <label class="flex items-center space-x-3">
                                    <input type="checkbox" name="requiere_especificaciones" value="1" {{ old('requiere_especificaciones') ? 'checked' : '' }} class="w-4 h-4 text-brand-600 border-gray-300 rounded focus:ring-brand-500">
