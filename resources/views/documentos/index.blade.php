            ...
            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-bold text-gray-900">
                    <div class="flex items-center">
                        ...
                        Documentos {{ $activoId ? ('del Activo #' . $activoId) : '' }}
                    </div>
                </h1>
                @if($activoId)
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($documentos as $d)
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#{{ $d->id_documento }}</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">{{ $d->tipo_documento ?: 'Documento general' }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($d->ruta_archivo)
                                        <a href="{{ $d->ruta_archivo }}" target="_blank" class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 hover:bg-blue-200 transition duration-200">
