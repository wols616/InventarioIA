            ...
            <form action="{{ route('categorias.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="vida_util_estimada_meses" id="vida_util_estimada_meses" value="{{ old('vida_util_estimada_meses') }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent">
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <label class="flex items-center space-x-3">
                                    <input type="checkbox" name="depreciable" {{ old('depreciable', '1') ? 'checked' : '' }} class="w-4 h-4 text-brand-600 border-gray-300 rounded focus:ring-brand-500">
                                    <span class="text-sm font-medium text-gray-700">Depreciable</span>
                                </label>
                                <label class="flex items-center space-x-3">
                                    <input type="checkbox" name="activo" {{ old('activo', '1') ? 'checked' : '' }} class="w-4 h-4 text-brand-600 border-gray-300 rounded focus:ring-brand-500">
