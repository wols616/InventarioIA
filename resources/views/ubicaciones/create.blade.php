...
@section('content')
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-2xl font-bold text-gray-900">Crear Ubicación</h1>
        </div>
            ...
            <form action="{{ route('ubicaciones.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent">
                    </div>

                    <div>
                        <label for="codigo_interno" class="block text-sm font-medium text-gray-700 mb-2">Código Interno</label>
                        <input type="text" name="codigo_interno" id="codigo_interno" value="{{ old('codigo_interno') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent">
                    </div>

                    <div class="flex items-center">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="estado" value="1" id="estado" {{ old('estado', '1') ? 'checked' : '' }} class="focus:ring-brand-500 h-4 w-4 text-brand-600 border-gray-300 rounded">
                        </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="descripcion_detallada" id="descripcion_detallada" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent" placeholder="Descripción de la ubicación...">{{ old('descripcion_detallada') }}</textarea>
                    </div>
                </div>

                <div id="area_info" class="bg-blue-50 border-l-4 border-blue-400 p-4 hidden">
                    <div class="flex">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <p><strong>Edificio:</strong> <span id="ai_edificio">-</span></p>
                                <p><strong>Piso:</strong> <span id="ai_piso">-</span></p>
                            </div>
                        </div>
                    </div>
                </div>
