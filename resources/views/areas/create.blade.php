...
@section('content')
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-2xl font-bold text-gray-900">Crear Área</h1>
        </div>
            ...
            <form action="{{ route('areas.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent" placeholder="Nombre del área">
                    </div>

                    <div>
                        <label for="tipo_area" class="block text-sm font-medium text-gray-700 mb-2">Tipo de Área</label>
                        <input type="text" name="tipo_area" id="tipo_area" value="{{ old('tipo_area') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent" placeholder="Ej: Oficina, Almacén, Laboratorio">
                    </div>
